...
class Card(object):
    ...
    def __init__(self, card_index):
        ...
        if self.value == "T":
            self.value = "0"
        self.face_img = pygame.transform.scale(pygame.image.load("card_images/"+self.full_filename()), (87,122))
        self.back_img = pygame.image.load("card_images/RedDotsCardBack.png")
    ...
    def render(self,screen,location):
        screen.blit(self.face_img,location)
